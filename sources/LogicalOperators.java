public class LogicalOperators {
    public static void main(String[] args) {
        ...
        if(inputUsername.equals(correctPassword) && inputPassword.equals(correctPassword)){
        ...
        boolean notcashOnCredit = !(option.equals("cash") || option.equals("credit"));
        ...
        boolean notHitOnStay = !(move.equals("hit") || move.equals("stay"));
